                        ...
                        TimePickerDialog timePickerDialog = new TimePickerDialog(addView.getContext(), R.style.Theme_AppCompat_Dialog,
                                new TimePickerDialog.OnTimeSetListener() {
                                    ...
                                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                        ...
                                        SimpleDateFormat hformate = new SimpleDateFormat("K:nn a",Locale.ENGLISH);
...
SaveEvent(EventName.getText().toString(),EventTime.getText().toString(),date,month,year);
        ...
        gridview.getOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            @Override
...
dbOpenHelper.SaveEvent(event,time,month,year,date,database);
dbOpenHelper.close();
